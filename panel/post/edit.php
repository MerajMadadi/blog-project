...
if (isset($_POST['title']) && $_POST['title'] !== ''
    ...
    $statement->execute([$_POST['title'], $_POST['body'], $category->id, $fileName, $post->id]);
    ...
    <section class="container-fluid">
        <section class="row">
            ...
            <section class="col-md-10 pt-3">
                ...
                <form action="<?= url('panel/post/edit.php?post_id=' . $post->id) ?>" method="post"
                    ...
                    <section class="form-group">
                        ...
                        <textarea class="form-control" name="body"
                                  id="body" rows="5" placeholder="body ..." cols=""><?= $post->body ?></textarea>
                    </section>
                    <section class="form-group">
